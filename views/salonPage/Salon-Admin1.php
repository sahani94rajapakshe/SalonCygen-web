...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-container w3-padding-large" style="margin-bottom:32px">
    ...
    <div class="w3-col m4 container">
      <img src="uploads/<?php echo $aboutimg1  ?>" alt="Sample" style="width:100%" height="250px">
       <div class="overlay">
    ...
    <div class="w3-col m4 container">
      <img src="uploads/<?php echo $aboutimg2  ?>" alt="Sample" style="width:100%" height="250px">
       <div class="overlay">
    ...
    <div class="w3-col m4 container">
      <img src="uploads/<?php echo $aboutimg3  ?>" alt="Sample" style="width:100%" height="250px">
       <div class="overlay">
...
<input type="hidden" name="image9" value="<?php echo $aboutimg3  ?>">
   ...
   <button style="width: 24%;padding: 2px;font-size: 20px;background-color: pink;
    padding: 12px 20px;
    border: none;
    border-radius: 4px;               
    cursor: pointer; float: left;text-align:center;margin-left:5px;" type="button" onclick="window.location.href='addService/addService.php'">Add Services</button>

     <button style="width: 25%;padding: 2px;font-size: 20px;background-color: Cyan;
    padding: 12px 20px;
    border: none;
    border-radius: 4px;
    cursor: pointer;float: left;" type="button" onclick="window.location.href='addEmployee/addEmployee.php'">Add Employee</button>
        
    <button style="width: 25%;padding: 2px;font-size: 20px;background-color: #6176a7;
    padding: 12px 20px;
    border: none;
    border-radius: 4px;
    cursor: pointer;float: left;" type="button" onclick="window.location.href='editCalander/editCalander.php'">Calander</button>    
    
    <button style="width: 24%;padding: 2px;font-size: 20px;background-color: lemonchiffon;
    padding: 12px 20px;
    border: none;
    border-radius: 4px;             
    cursor: pointer;float: left;" type="button" onclick="window.location.href='addDiscount/addDiscount.php'" >Add Discount</button>
