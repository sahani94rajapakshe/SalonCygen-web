...
$employeeEmail= $row2['employeeEmail'];
      ...
      $mail = new PHPMailer(true);
            ...
            try {
                ...
                $mail->Subject = 'Appoinment for '.$salonName.' ';
                $mail->Body    = 'I made an appoinment for '.$salonName.' on '.$bookingDate.' for '.$employeeName.' at '.$time.' for a '.$service.' .Thank You.';
                ...
                echo "<script>window.location.href='../../salonPage/index.php';</script>";
