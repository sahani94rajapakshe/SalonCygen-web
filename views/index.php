...
/*For Recommendation*/
include ('salonPage/recommendationEngine/recommSimilarity.php');
...
$cusUsernamet = mysqli_fetch_array($users);

/*print_r($cusUsernamet);*/


  $matrix[$cusUsernamet['cusUsername']][$salon['salonName']] = $salon['rateAmount'];



}

$users = mysqli_query($conn, " select cusUsername from customers where cusUsername= '$cusUsername'");
$cusUsernamev = mysqli_fetch_array($users);
/*//For Recommendation*/
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
         ...
         <li class="nav-item active"><a href="salonPage/salonListView/allSalons.php" class="nav-link">Salons</a></li>
         ...
         <li class="nav-item active"><a href="admin/login/login1/index.php" class="nav-link">Admin</a></li>
                ...
                <?php
                  ...
                  ?>
                <li class="nav-item active"><a href="index.php" class="nav-link">Home</a></li>
               <li class="nav-item active"><a href="./admin/adminPage.php" class="nav-link">Admin</a></li>
                <li class="nav-item active"><a href="logout/logout.php" class="nav-link">Sign Out</a></li>
                <?php  
                }
                ?>
              ...
              <!-- Search form -->
               <form action="./salonPage/salonListView/page_list_result.php"  class="search-property-1" method = "POST" enctype="multipart/form-data"> 
		        		<div class="row">
                         ...
                         <input type="text" name ="search" class="form-control" placeholder="Search by location or salon name">
				              </div>
			              </div>
		        			</div>
		        			<!-- <div class="col-lg align-items-end">
               ...
               <div class="text">
                ...
                <div class="star d-flex clearfix">
                  ...
                  <div class="float-right">
                    ...
                    <form method="POST" action="./salonPage/takeIdIndex.php">
...
<!-- //Ratings salons -->
 ...
 <?php
if ($_SESSION['role']==2){
  if ($cusUsernamet['cusUsername'] = $salon['cusUsername']) {
  ?>
     <section class="ftco-section" >
    ...
    <div class="container">
      ...
      <table width="100%" cellspacing="0" cellpadding="2" border="0" style="overflow: wrap"> 
       <tr> 
        ...
        $rec = array();
        $rec = getRecommendation($matrix, $cusUsernamev['cusUsername']);
        

        foreach ($rec as $salonName => $ratings) {
          /*print_r($cusUsernamev['cusUsername']);
