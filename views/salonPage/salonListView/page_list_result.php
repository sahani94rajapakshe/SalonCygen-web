...
if (isset($_POST['submit-search'])) {
      ...
      $sql = " SELECT * FROM salon_info WHERE location1 LIKE '%$search%' or salonName LIKE '%$search%'  ORDER BY rand()";
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
                ...
                if ($_SESSION['role']==1){
                 ...
                 <li class="nav-item active"><a href="allSalons.php" class="nav-link">Salons</a></li>
